    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-zinc-950/70 backdrop-blur">
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm text-zinc-400">
          ...
          <a href="#inside" className="hover:text-zinc-100">
            Внутри
          </a>
          <a href="#cases" className="hover:text-zinc-100">
            Кейсы
          </a>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              fbqTrack("Lead", { place: "header_start" });
              onQuiz();
            }}
      ...
      {open && (
        <div className="md:hidden border-t border-white/10 bg-zinc-950/95 backdrop-blur">
          <div className="mx-auto max-w-6xl px-4 py-3 grid gap-2 text-base">
            <a href="#services" className="py-3" onClick={() => setOpen(false)}>
              Услуги
            </a>
            <a href="#inside" className="py-3" onClick={() => setOpen(false)}>
              Внутри
            </a>
            <a href="#cases" className="py-3" onClick={() => setOpen(false)}>
              Кейсы
            </a>
            <a href="#pricing" className="py-3" onClick={() => setOpen(false)}>
              Тарифы
            </a>
            <a href="#faq" className="py-3" onClick={() => setOpen(false)}>
              FAQ
            </a>
            <button
              onClick={() => {
                setOpen(false);
                fbqTrack("Lead", { place: "menu_write" });
                onQuiz();
              }}
...
/* ---------------- Hero (мобайл плотный, с бегущей строкой) ---------------- */
function KPMobileHero({ onQuiz }: { onQuiz: () => void }) {
  ...
  return (
    <Section
      id="home"
      className="min-h-[82vh] flex flex-col justify-between pt-0 pb-4 sm:pt-2 sm:pb-6"
    ...
    >
      ...
      <div className="-mx-4 sm:mx-0">
        <div className="overflow-hidden border border-zinc-200 sm:rounded-md">
          ...
          <div className="px-4 sm:px-5 py-5 sm:py-6 space-y-5">
            ...
            <h1 className="text-[32px] sm:text-[40px] leading-[1.08] font-extrabold tracking-tight">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <button
                onClick={() => {
                  fbqTrack("Lead", { place: "kp_mobile_tg" });
                  onQuiz();
                }}
      ...
      {/* Бегущая строка прямо в первом экране */}
      <div className="mt-3">
  ...
  return (
    <>
      ...
      <div className="hidden sm:block">
        <Section id="home" className="pt-12 pb-12 sm:pt-12 sm:pb-12" bg="bg-white text-zinc-900">
          <motion.div
            variants={container}
            initial="hidden"
            animate="show"
      ...
      <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-sm">
        {groups.map((g, i) => (
          <li key={i} className="rounded-2xl border border-white/10 p-4 flex flex-col justify-between">
            ...
            <button
              onClick={() => {
                fbqTrack("Lead", { place: "services_card", title: g.title });
                onQuiz();
              }}
...
function Pricing({ onQuiz }: { onQuiz: () => void }) {
  const plans = [
    ...
    },
    {
      ...
      features: ["Пачки креативов", "Мультиканальный баинг", "Сквозная аналитика", "Автоматизация"],
      highlight: true,
    },
    {
      name: "Скейл",
      ...
      features: ["Кастомная команда", "R&D и анти-бан", "Серверный трекинг", "SLA по KPI"],
      highlight: false,
    },
  ];
  return (
      ...
      <ul className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3">
        {plans.map((p, i) => (
          <li key={i} className={`rounded-2xl border p-5 ${p.highlight ? "border-zinc-300" : "border-zinc-200"}`}>
            ...
            <button
              onClick={() => {
                fbqTrack("Lead", { place: "pricing", plan: p.name });
                onQuiz();
              }}
...
function QuizModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const choose = (opt: string) => {
    ...
    else setStep(step + 1); // финальный экран
  };
    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-6">
      ...
      <div className="relative z-[101] w-full sm:max-w-lg rounded-t-2xl sm:rounded-2xl bg-white text-zinc-900 shadow-2xl">
        <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200">
          ...
          <button
            onClick={() => { goTG("quiz_x_close"); onClose(); }}
          ...
          <div className="px-5 py-5 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a
                ...
                onClick={() => goTG("quiz_confirm_submit")}
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                onClick={() => goTG("quiz_confirm_close")}
                className="inline-flex items-center justify-center rounded-xl border border-zinc-300 px-4 py-2 text-sm w-full sm:w-auto"
              >
                Закрыть
              </a>
...
export default function App() {
  ...
  useEffect(() => {
    fbqTrack("ViewContent", { content_name: "TraffAgent Landing" });
  }, []);
  return (
